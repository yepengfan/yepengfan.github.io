      ...
      <div className="flex gap-4 overflow-x-auto">
        {images.slice(1).map((image) => (
          <button
            key={image.image_url}
            type="button"
            className="p-0 border-none bg-transparent rounded-lg h-full w-[80px] object-cover focus:outline-none"
            onClick={() => {
          ...
          >
            <img
              className="rounded-lg h-full w-[80px] object-cover pointer-events-none"
              src={image.image_url}
